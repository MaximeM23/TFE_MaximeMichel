...
namespace app_tfe_michel_maxime
{
    ...
    public static partial class Outils
    {
        ...
        /// <summary>
        /// Permet de calculer le nombre de caractères correspondant à la valeur dans une phrase
        /// </summary>
        /// <param name="phrase">Phrase dans laquelle il faut rechercher</param>
        /// <param name="value">Caractère à rechercher dans la phrase</param>
        /// <returns></returns>
        public static int NombreDeCaractereCorrespondant(string phrase, char value)
        {
            int nbrCaractere = 0;
            for(int i = 0;i < phrase.Length;i++)
            {
                if(phrase[i].Equals(value))
                {
                    nbrCaractere++;
                }
            }
